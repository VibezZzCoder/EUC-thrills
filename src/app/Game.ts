...
import { INSPECTION_CAMERA, CAMERA, CHALLENGE, EUC, INPUT, RIDER, TARGET, WHEEL } from '../data/tuning.ts';
...
import { EucController, copyPose, createPose, type EucPose, type EucSnapshot } from '../simulation/EucController.ts';
...
import { Paddle, type SwingPhase } from '../simulation/paddle.ts';
