...
out('```');
out();
out('"Everything else" is the rider rig, the **second rider**, the checkpoint');
...
out('them on each axis. That is either playable rider wearing either second');
out('rider: a Time-trial ghost, or M18\'s chase cop. The two are alternatives');
